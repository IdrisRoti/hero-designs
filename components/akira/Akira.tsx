  ...
  return (
    <div className="bg-[#F5F5EC]">
        ...
        <section className="text-center mt-12 md:mt-16 flex flex-col items-center justify-center px-4">
            <motion.h3 animate={{opacity: [0, 1], y: [-20, 0]}} transition={{duration: 1}} className="uppercase tracking-[0.3rem] text-[#6D6F65] font-medium">Introducing</motion.h3>
            ...
            <motion.p animate={{opacity: [0, 1]}} transition={{duration: .8, delay: 3}} className="md:w-[75%] lg:w-[50%] text-[#6D6F65] md:text-xl lg:text-2xl">Discover the power of clean beauty, where purity meets performance. Feel good about what you put on your skin—because you deserve products that are as kind to you as they are to the planet.</motion.p>
            <motion.div animate={{opacity: [0, 1]}} transition={{duration: .8, delay: 3}} className="flex items-center justify-center gap-4 mt-6">
                <button className="px-8 py-3 lg:py-5 text-[#37392E] border-[1.5px] border-[#37392E] rounded-full uppercase font-medium hover:opacity-65 transition">get samples</button>
                <button className="px-8 py-3 lg:py-5 text-white bg-[#37392E] border-[1.5px] border-[#37392E] rounded-full uppercase font-medium hover:opacity-65 transition">Shop now</button>
            </motion.div>
        </section>
        <motion.section animate={{opacity: [0, 1], y: [20, 0]}} transition={{delay: 3.5, duration: .8}} className="w-screen md:w-full max-w-[100rem] mx-auto mt-20 grid grid-cols-1 md:grid-cols-3 items-center overflow-hidden">
            {
