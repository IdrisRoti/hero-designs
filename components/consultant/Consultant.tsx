        ...
        <div className="absolute w-[85%] md:w-[75%] lg:w-1/2 h-full top-0 right-0 flex items-start justify-end">
            {
                gradientsArr.map(({id, gradient,delay}) => (
                    <motion.div initial={{opacity: .5}} animate={{opacity: 1}} transition={{duration: 2, ease: "easeInOut", delay: delay, repeat: Infinity, repeatType: "reverse"}} key={id} className={`w-full bg-gradient-to-b h-full ${gradient}`} />
                ))
            }
        </div>
        <div className="relative max-w-[75rem] h-full mx-auto">
            <motion.nav initial={{ opacity: 0}} animate={{ opacity: 1}} transition={{duration: .8, delay: 2}} className="absolute top-6 left-0 w-full">
            ...
            <div className="absolute w-full bottom-0 left-0 flex flex-col gap-4 md:gap-0 text-[#1e1e1e]">
                <div className="w-full">
                    <motion.h1 initial={{ opacity: 0}} animate={{ opacity: 1}} transition={{duration: .8}} className="text-[#1e1e1e]/80 capitalize md:text-xl tracking-wider">Award winning business consultant</motion.h1>
                    <motion.h1 initial={{ opacity: 0}} animate={{ opacity: 1}} transition={{duration: .8, delay: 1}} className="text-3xl md:text-5xl w-[90%] lg:w-[65%] mt-4 mb-12">Our experts will build you a next level strategy to accelerate your e-commerce & grow your business.</motion.h1>
                    <motion.div initial={{ opacity: 0}} animate={{ opacity: 1}} transition={{duration: .8, delay: 2}} className="flex items-center gap-4">
                ...
                <motion.div initial={{ opacity: 0}} animate={{ opacity: 1}} transition={{duration: .8, delay: 2}} className="relative w-44 h-32 border-4 border-orange-600 rounded-md aspect-square  ml-auto mb-8 after:absolute after:inset-0 after:bg-black/10">
                    <Image
