...
const Header = () => {
  return (
    <header className="h-20 relative z-50">
        <nav className="h-full flex items-center justify-between gap-3">
            <Image
            ...
            <div className="flex items-center gap-2 md:gap-3 overflow-hidden">
                        {
                            ...
                            return  (
                                    <motion.button
                                        ...
                                        className='w-8 md:w-10 aspect-square border border-[#1e1e1e]/80 hover:bg-[#1e1e1e]/90 hover:text-white transition rounded-full grid place-items-center'
                                        key={i}>
                                        <Icon />
                                    </motion.button>
                            )
