  ...
  return (
    <>
            <motion.div
                ...
                animate="animate"
                exit="exit" 
                className="absolute w-screen text-[#1e1e1e] top-0 left-0 bg-white overflow-hidden px-10 h-screen flex flex-col z-50"
            >
                {
                    navlinks.map((link) => (
                ...
                <button onClick={() => setShowMenu(false)} className="overflow-hidden md:text-2xl mb-6 mt-10 md:mt-0 uppercase flex justify-center">
                            {
